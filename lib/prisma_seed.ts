...
const countryList = [
    ...
    'French Southern Territories (the)', 'Gabon', 'Gambia (the)', 'Georgia', 'Germany',
    ...
    'Malawi', 'Malaysia', 'Maldives', 'Mali', 'Malta', 'Marshall Islands (the)', 'Martinique',
    ...
    'Turkey', 'Turkmenistan', 'Turks and Caicos Islands (the)', 'Tuvalu', 'Uganda', 'Ukraine',
...
async function main() {
    try {
        ...
        console.log('Country data has been seeded.');
    } catch (error) {
