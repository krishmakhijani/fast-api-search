...
const redis = new Redis({
  url: 'https://saved-oyster-62129.upstash.io',
  token: 'AfKxAAIjcDEzNGMyMmRmMTgwMTk0NzQyODEyNDFhZGQ1ZGIwMDJlOHAxMA',
})
...
countryList.forEach((country) => {
    ...
    const populateDb = async () => {
        // @ts-expect-error not knowing the specific reason
